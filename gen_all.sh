...
$(cd user_service/protocol && protoc --go_out=. -I.  -I ${GOPATH}/src/github.com/envoyproxy/protoc-gen-validate --go_opt=paths=source_relative     --go-grpc_out=. --go-grpc_opt=module=github.com/KIRAKIRA-DOUGA/KIRAKIRA-golang-backend/user_service/protocol  --validate_opt=module=github.com/KIRAKIRA-DOUGA/KIRAKIRA-golang-backend/user_service/protocol --validate_out="lang=go:."   userservice.proto)
